...
class TextPixbufUtils < MiniTest::Test
  ...
  def test_equalize
    ...
    p layout.pixel_extents[0].width
    cr.move_to(10,10)
    ...
    img.write_to_png("output/auto_equalize/#{File.basename jpeg}.png")
    pb.save("output/auto_equalize/#{File.basename jpeg, '.JPG'}.orig.jpg", "jpeg")
    equal.save("output/auto_equalize/#{File.basename jpeg, '.JPG'}.equalized.jpg", "jpeg")
    end
  end
end
